    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button variant="primary" onClick={adicionarCurtida}> {//Curtir
                                           }
                ...
                </Button> <Button variant="primary" onClick={adicionarDescurtida}> {//Não Curtir
                                           }
                ...
                <Button onClick={() => {props.setDetalharCandidato(true); props.setCandidatoSelecionado(props.candidato);}} className="mt-1" variant="success">Conheça minhas propostas</Button>
            </Card.Body>
        </Card>
    );
}